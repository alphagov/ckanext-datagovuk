# sourced from github.com/ckan/ckan-solr/blob/master/solr-8/Dockerfile.spatial
FROM solr:8
...
RUN sed -z 's/<schema name="ckan-2.10" version="1.6">/<schema name="ckan" version="2.9">/' -i $SOLR_SCHEMA_FILE
