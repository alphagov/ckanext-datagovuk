web: unicornherder --gunicorn-bin ./venv/bin/gunicorn -p /var/run/ckan/unicornherder.pid -- --pythonpath ${CKAN_HOME} wsgi_app:application --bind 127.0.0.1:${PORT:-3220} --workers ${GUNICORN_WORKER_PROCESSES} --log-file /var/log/ckan/app.out.log
